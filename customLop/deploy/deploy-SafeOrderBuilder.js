...
const ORDER_REGISTRATOR_SALT = ethers.utils.keccak256(ethers.utils.toUtf8Bytes('OrderRegistrator'));
const SAFE_ORDER_BUILDER_SALT = ethers.utils.keccak256(ethers.utils.toUtf8Bytes('SafeOrderBuilder'));
