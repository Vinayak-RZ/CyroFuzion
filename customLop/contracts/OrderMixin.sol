...
abstract contract OrderMixin is IOrderMixin, EIP712, PredicateHelper, SeriesEpochManager, Pausable, OnlyWethReceiver, PermitAndCall {
    ...
    function _fill(
        ...
        // Maker => Taker
        {
            ...
            emit OrderVerified(order.suiAsset, order.crossChainRecepient, order.maker.get(), order.takerAsset.get(), order.makingAmount, order.takingAmount);
        ...
        bool isCrossChainOrder = order.suiAsset.length > 0;
